...
def new_child_thread(connectionSocket, address):
    ...
    for rfc in server_data[1]:
        ...
        # combined_rfc_value = [str(rfc_num), rfc_ttl, address[0], str(server_data[0])]
    ...
    while True:
        ...
        if client_data == 'exit':
            ...
            if client_data[1] == "get":
                ...
                connectionSocket.send(pickle.dumps([connection_msg,(combined_rfc_list, ['RFC_Number', 'RFC_Title',
